...
public class Pytorchmodel {
        ...
        public static void main(String[] args) throws IOException, OrtException {
            ...
            HuggingFaceTokenizer tokenizer = HuggingFaceTokenizer.newInstance(Paths.get("artifacts/finetuned_albert/tokenizer.json"));
            ...
            OrtSession session = environment.createSession("artifacts/finetuned_albert/model2.onnx");
            ...
            String[] tokens = encodings[0].getTokens();
